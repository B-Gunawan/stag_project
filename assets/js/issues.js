...
function issues_line_graph(memberIssues, chart_id, legend_id){
    /*
...
issues_line_dashboard = issues_line_graph(best_memberIssues_top, dash_issues_line_id, dash_issues_line_legend_id)
